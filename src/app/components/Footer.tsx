          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="text-gray-300 hover:text-blue-400 transition-all duration-300 text-xl hover:scale-110"
                aria-label="GitHub"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-pink-400 transition-all duration-300 text-xl hover:scale-110"
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              <p className="flex items-center">
                ...
                <a href="mailto:natnaeldarsema@gmail.com" className="hover:text-white transition-colors duration-300">
